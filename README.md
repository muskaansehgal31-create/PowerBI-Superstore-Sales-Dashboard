...
A line chart showing sales growth over the years (2014–2017) to track business performance over time.

2️⃣ Sales by Ship Mode

A donut chart displaying how sales are distributed across different shipping methods:
...
A bar chart highlighting sales performance across regions.

4️⃣ Sales by Category

A category distribution chart showing which product categories generate the most revenue.

5️⃣ Top Products

A product ranking chart identifying top-selling products.

6️⃣ Profit Margin Gauge

A KPI gauge visualizing the overall profit margin performance.
